...
- Developed and tested with MATLAB R2022b and Gmsh 4.15.2.
- No additional MATLAB toolboxes are required.
- Tetrahedral meshes are generated by the supplied `prepare_mesh_*.m` routines.

## Citation

If you use this code, please cite:

> Jae Young Lee, “Hidden Mechanical Information beyond the Static Limit,”
> *Submitted*
